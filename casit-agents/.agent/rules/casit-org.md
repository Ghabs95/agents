...
See [casit-workflows.md](../workflows/casit-workflows.md) for the detailed Standard Operating Procedures (SOPs) that define how work flows through the agent organization.
