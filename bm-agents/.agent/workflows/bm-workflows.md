...
# BIOME — Standard Operating Procedures (SOPs)
...
| 9  | **Post-Release Metrics** | `@GrowthLead`       | Monitor key metrics for 24h             | No regression                           |
...
| 2 | **Impact Analysis**      | `@Architect`                  | Affected projects list, breaking change assessment, migration plan | —                                                |
...
|-------------------------------|---------------------------------------------------|------------------------------------|
| **API contract change**       | `@BackendLead` + `@FrontendLead`                  | Backend → Frontend                 |
